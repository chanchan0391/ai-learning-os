...
update_operational_runners() {
  for runner in deploy-main.sh backup.sh backup-health.sh application-health.sh crash-evidence.sh operations-metrics.sh record-monitor-success.sh host-capacity.sh verify-backup.sh restore-drill.sh resolve-docker-bin.sh; do
