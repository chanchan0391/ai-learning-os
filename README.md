...
- 阶段与目标掌握度检查：阶段完成后汇总理解、应用、证据和反思四维评估；目标级汇总区分日程完成与全部阶段证据达标，并优先指出最需要补证据的阶段；补强实践保留来源并在评估后展示四维与总分变化，同时保持当天总时间预算不变；最终阶段未达标时可在计划结束后开启补强学习日再归档
...
- 已完成目标归档：保留完整计划与学习证据，登录后跨设备上传和下载，可恢复查看并立即创建下一个目标
